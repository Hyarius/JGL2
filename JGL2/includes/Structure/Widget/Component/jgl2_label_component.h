...
namespace jgl
{
	...
	{
	public:
		static jgl::Size_t textSize;
		static jgl::Size_t outlineSize;
		static jgl::Color textColor;
		static jgl::Color outlineColor;
		static jgl::HorizontalAlignment horizontalAlignment;
		static jgl::VerticalAlignment verticalAlignment;
	};
