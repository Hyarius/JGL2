...
namespace jgl
{
	...
	private:
		...
		Vector2Int _prepareCharRender(WChar p_char, Vector2Int p_pos, UInt p_size, Color p_color, Color p_outlineColor);
	...
	public:
		...
		Vector2Int draw(WChar p_char, Vector2Int p_pos, UInt p_size, Color p_color, Color p_outlineColor = jgl::Color(0, 0, 0, 0));
		Vector2Int draw(std::string p_string, Vector2Int p_pos, UInt p_size, Color p_color, Color p_outlineColor = jgl::Color(0, 0, 0, 0));
	};
}