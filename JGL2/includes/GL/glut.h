...
/**
 ...
 glutFontLength, glutStrokeLength, glutWindowStatusFunc, dynamic
...
/* Font font constants (use these in GLUT program). */
...
/* Font font opaque addresses (use constants instead in source code). */
extern void *glutFont9By15;
extern void *glutFont8By13;
extern void *glutFontTimesRoman10;
extern void *glutFontTimesRoman24;
extern void *glutFontHelvetica10;
extern void *glutFontHelvetica12;
extern void *glutFontHelvetica18;

/* Font font constants (use these in GLUT program). */
#define GLUT_BITMAP_9_BY_15		(&glutFont9By15)
#define GLUT_BITMAP_8_BY_13		(&glutFont8By13)
#define GLUT_BITMAP_TIMES_ROMAN_10	(&glutFontTimesRoman10)
#define GLUT_BITMAP_TIMES_ROMAN_24	(&glutFontTimesRoman24)
#if (GLUT_API_VERSION >= 3)
#define GLUT_BITMAP_HELVETICA_10	(&glutFontHelvetica10)
#define GLUT_BITMAP_HELVETICA_12	(&glutFontHelvetica12)
#define GLUT_BITMAP_HELVETICA_18	(&glutFontHelvetica18)
#endif
#endif
...
/* GLUT font sub-API */
extern void APIENTRY glutFontCharacter(void *font, int character);
extern int APIENTRY glutFontWidth(void *font, int character);
...
#if (GLUT_API_VERSION >= 4 || GLUT_XLIB_IMPLEMENTATION >= 9)
extern int APIENTRY glutFontLength(void *font, const unsigned char *string);
