...
int main(int argc, char** argv)
{
	...
	tmpWidget2->setGeometry(40, tmpWidget->usableSize() - jgl::Vector2Int(80, 80));
	tmpWidget2->setColor(jgl::Color(0, 255, 0));
	tmpWidget2->activate();

	Frame* tmpWidget3 = new Frame(tmpWidget2);
	tmpWidget3->setGeometry(40, tmpWidget2->usableSize() - jgl::Vector2Int(80, 80));
	tmpWidget3->setColor(jgl::Color(0, 0, 255));
	tmpWidget3->activate();

	Frame* tmpWidget4 = new Frame(tmpWidget3);
	tmpWidget4->setGeometry(40, tmpWidget3->usableSize() - jgl::Vector2Int(80, 80));
